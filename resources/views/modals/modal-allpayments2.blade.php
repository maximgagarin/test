<div class="modal fade" id="AllPaymentsModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Все счета</h5>
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered mb-5">
                    ...
                    <tbody>
                    @foreach($AllPayments2 as $payment)
